    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('http://rsg-mdtmedic/getWarrants');
        ...
        closeMDT() {
            $.post('http://rsg-mdtmedic/close', JSON.stringify({}));
        },
        getClass(element) {
        ...
        OffenderSearch() {
            if (this.offender_search) {
                ...
                $.post('http://rsg-mdtmedic/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('http://rsg-mdtmedic/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://rsg-mdtmedic/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://rsg-mdtmedic/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && this.report_new.incident) {
                $.post('http://rsg-mdtmedic/submitNewReport', JSON.stringify({
        ...
        SubmitNote() {
            if (this.note_new.title && this.note_new.note) {
                $.post('http://rsg-mdtmedic/submitNote', JSON.stringify({
        ...
        OpenOffenderDetailsById(charidentifier) {
            $.post('http://rsg-mdtmedic/getOffender', JSON.stringify({
        ...
        DeleteSelectedReport() {
            $.post('http://rsg-mdtmedic/deleteReport', JSON.stringify({
        ...
        DeleteSelectedNote() {
            $.post('http://rsg-mdtmedic/deleteNote', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://rsg-mdtmedic/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        SaveNoteEditChanges() {
            $.post('http://rsg-mdtmedic/saveNoteChanges', JSON.stringify({
                id: this.note_selected.id,
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://rsg-mdtmedic/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://rsg-mdtmedic/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://rsg-mdtmedic/getReport', JSON.stringify({
                id: id
            }));
            this.modal = 'loading';
            return;
